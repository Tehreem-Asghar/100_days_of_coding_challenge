...
function updatingVariable() {
    var ispresent = true; // initially assign the value true
    console.log("initial value : ".concat(ispresent)); // logs the initial value
    ispresent = false; // updates the value false
    console.log("update value : ".concat(ispresent)); // logs the update value
}
updatingVariable();
